...
const rows = [
  ["لبنة", 7000, "فطاير"],
  ["جبنه", 7000, "فطاير"],
  ["جبنه وخضار", 8000, "فطاير"],
  ["محمره", 5000, "فطاير"],
  ["زعتر", 5000, "فطاير"],
  ["زعتر وخضار", 6000, "فطاير"],
  ["محمره وقشقوان", 10000, "فطاير"],
  ["زعتر وقشقوان", 10000, "فطاير"],
  ["ببيروني وقشقوان", 12000, "فطاير"],
  ["ببيروني وزيتون وفطر", 8000, "فطاير"],
  ["ببيروني وزيتون وقشقوان وفطر", 13000, "فطاير"],
  ["بيتزا ببيروني صغير", 14000, "بيتزا"],
  ["بيتزا ببيروني وسط", 50000, "بيتزا"],
  ["بيتزا ببيروني عائلي", 70000, "بيتزا"],
  ["بيتزا ١", 12000, "بيتزا"],
  ["بيتزا ٢", 20000, "بيتزا"],
  ["بيتزا ٣", 30000, "بيتزا"],
  ["بيتزا ٤", 40000, "بيتزا"],
  ...
  ["سنفوره", 11000, "فطاير"],
  ["قشقوان", 10000, "فطاير"],
  ["مرتديلا وقشوان", 12000, "فطاير"],
  ["قشقوان وزيتون وفطر", 10000, "فطاير"],
  ["سجق", 11000, "فطاير"],
  ["توشكا", 15000, "فطاير"],
  ["فاهيتا", 15000, "فطاير"],
